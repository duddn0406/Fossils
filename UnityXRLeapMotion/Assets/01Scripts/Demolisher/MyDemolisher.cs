...
public class MyDemolisher : MonoBehaviour
{
    ...
    public void CustomDemolish()
    {
        ...
        {
            Rigidbody rigid = res[i].AddComponent<Rigidbody>();
            rigid.freezeRotation = true;
            MeshCollider mesh = res[i].AddComponent<MeshCollider>();
            mesh.convex = true;
        }

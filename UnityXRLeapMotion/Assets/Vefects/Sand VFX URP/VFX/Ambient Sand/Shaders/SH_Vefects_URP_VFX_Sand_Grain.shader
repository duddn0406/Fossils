...
Shader "Vefects/SH_Vefects_URP_VFX_Sand_Grain"
{
	Properties
	{
		...
		_ErosionSmoothness("Erosion Smoothness", Float) = 0.3
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_65_0 = saturate( distanceDepth21 );
				float temp_output_67_0 = ( ( input.ase_texcoord9.z - temp_output_65_0 ) + temp_output_65_0 );
				float2 uv_Grain = input.ase_texcoord9.xy * _Grain_ST.xy + _Grain_ST.zw;
				float smoothstepResult61 = smoothstep( temp_output_67_0 , ( temp_output_67_0 + _ErosionSmoothness ) , tex2D( _Grain, uv_Grain ).g);
				

				float3 BaseColor = input.ase_color.rgb;
				...
				float Occlusion = 1;
				float Alpha = saturate( smoothstepResult61 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_65_0 = saturate( distanceDepth21 );
				float temp_output_67_0 = ( ( input.ase_texcoord3.z - temp_output_65_0 ) + temp_output_65_0 );
				float2 uv_Grain = input.ase_texcoord3.xy * _Grain_ST.xy + _Grain_ST.zw;
				float smoothstepResult61 = smoothstep( temp_output_67_0 , ( temp_output_67_0 + _ErosionSmoothness ) , tex2D( _Grain, uv_Grain ).g);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_65_0 = saturate( distanceDepth21 );
				float temp_output_67_0 = ( ( input.ase_texcoord4.z - temp_output_65_0 ) + temp_output_65_0 );
				float2 uv_Grain = input.ase_texcoord4.xy * _Grain_ST.xy + _Grain_ST.zw;
				float smoothstepResult61 = smoothstep( temp_output_67_0 , ( temp_output_67_0 + _ErosionSmoothness ) , tex2D( _Grain, uv_Grain ).g);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_65_0 = saturate( distanceDepth21 );
				float temp_output_67_0 = ( ( input.ase_texcoord2.z - temp_output_65_0 ) + temp_output_65_0 );
				float2 uv_Grain = input.ase_texcoord2.xy * _Grain_ST.xy + _Grain_ST.zw;
				float smoothstepResult61 = smoothstep( temp_output_67_0 , ( temp_output_67_0 + _ErosionSmoothness ) , tex2D( _Grain, uv_Grain ).g);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_65_0 = saturate( distanceDepth21 );
				float temp_output_67_0 = ( ( input.ase_texcoord5.z - temp_output_65_0 ) + temp_output_65_0 );
				float2 uv_Grain = input.ase_texcoord5.xy * _Grain_ST.xy + _Grain_ST.zw;
				float smoothstepResult61 = smoothstep( temp_output_67_0 , ( temp_output_67_0 + _ErosionSmoothness ) , tex2D( _Grain, uv_Grain ).g);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_65_0 = saturate( distanceDepth21 );
				float temp_output_67_0 = ( ( input.ase_texcoord.z - temp_output_65_0 ) + temp_output_65_0 );
				float2 uv_Grain = input.ase_texcoord.xy * _Grain_ST.xy + _Grain_ST.zw;
				float smoothstepResult61 = smoothstep( temp_output_67_0 , ( temp_output_67_0 + _ErosionSmoothness ) , tex2D( _Grain, uv_Grain ).g);
				

				surfaceDescription.Alpha = saturate( smoothstepResult61 );
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-2432,1408;Inherit;False;Property;_DepthFadeDistance;Depth Fade Distance;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;21;-2432,1280;Inherit;False;True;True;False;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;66;-2432,896;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;65;-2432,1152;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;71;-1920,1024;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;67;-1920,896;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-1664,1024;Inherit;False;Property;_ErosionSmoothness;Erosion Smoothness;4;0;Create;True;0;0;0;False;0;False;0.3;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;62;-2432,512;Inherit;True;Property;_Grain;Grain;1;0;Create;True;0;0;0;False;0;False;-1;0ef96abca4267444da70d77533f383b2;0ef96abca4267444da70d77533f383b2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleAddOpNode;68;-1664,896;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;61;-1920,512;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;64;-1664,512;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;70;-2176,1152;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-1152,256;Inherit;False;Property;_Specular;Specular;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-1152,128;Inherit;False;Property;_Emission;Emission;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-1152,384;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;76;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;1;9;72;0
WireConnection;1;4;73;0
WireConnection;1;6;64;0
ASEEND*/
//CHKSM=E34439414CB41ABB5CD9BD6792F1DD2B5A8D0842
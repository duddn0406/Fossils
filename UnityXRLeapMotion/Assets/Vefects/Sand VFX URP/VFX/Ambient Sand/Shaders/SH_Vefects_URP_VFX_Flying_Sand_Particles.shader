...
Shader "Vefects/SH_Vefects_URP_VFX_Flying_Sand_Particles"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 temp_output_74_0 = (input.ase_color).rgb;
				float3 lerpResult69 = lerp( ( temp_output_74_0 * float3( 0,0,0 ) ) , temp_output_74_0 , saturate( ( ase_vface > 0 ? +1 : -1 ) ));
				...
				float temp_output_67_0 = ( input.ase_texcoord9.z + saturate( distanceDepth21 ) );
				float2 uv_Grain = input.ase_texcoord9.xy * _Grain_ST.xy + _Grain_ST.zw;
				float smoothstepResult61 = smoothstep( temp_output_67_0 , ( temp_output_67_0 + 0.01 ) , tex2D( _Grain, uv_Grain ).g);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float screenDepth21 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_67_0 = ( input.ase_texcoord3.z + saturate( distanceDepth21 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float screenDepth21 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_67_0 = ( input.ase_texcoord4.z + saturate( distanceDepth21 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float screenDepth21 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_67_0 = ( input.ase_texcoord2.z + saturate( distanceDepth21 ) );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float screenDepth21 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_67_0 = ( input.ase_texcoord5.z + saturate( distanceDepth21 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float screenDepth21 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth21 = saturate( ( screenDepth21 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float temp_output_67_0 = ( input.ase_texcoord.z + saturate( distanceDepth21 ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-2432,1152;Inherit;False;Property;_DepthFadeDistance;Depth Fade Distance;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;21;-2432,1024;Inherit;False;True;True;False;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;65;-2432,896;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;66;-2432,1280;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;67;-1920,896;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;68;-1792,896;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;1024,0;Inherit;False;Property;_Cull;Cull;2;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;1536,0;Inherit;False;Property;_Dst;Dst;4;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;1280,0;Inherit;False;Property;_Src;Src;3;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;1792,0;Inherit;False;Property;_ZWrite;ZWrite;5;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;58;2048,0;Inherit;False;Property;_ZTest;ZTest;6;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;64;-1664,512;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;69;-1152,0;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TwoSidedSign;70;-2432,-256;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;72;-2176,-256;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;74;-2176,0;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;73;-1664,128;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;75;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;1;0;69;0
WireConnection;1;6;64;0
ASEEND*/
//CHKSM=5F9B4B32299FC2952D5D89AD6195D987E984E20F